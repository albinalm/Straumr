# Straumr Documentation

This directory documents Straumr from three angles:

- How to use it as an end user.
- How it stores and resolves data on disk.
- How the codebase is structured and released.
...
- [Themes](./theme.md): choose, create, and customize terminal UI colour themes.
...
If you are new to Straumr, read:

1. [User Workflows](./user-workflows.md)
2. [Command Reference](./command-reference.md)
3. [Themes](./theme.md)
4. [Data Model](./data-model.md)

If you are changing the codebase, read:
