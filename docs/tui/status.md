...
- Active screen: none. Requests is accepted; Auths (A1) is next and not started
...
- The developer accepted the Requests screen on 2026-09-15, after a session of terminal passes that
  produced the fixes listed in the entries above and in `changelog.md`. R1 is complete.
