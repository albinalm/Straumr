...
| [screen-auths.md](./screen-auths.md) | A1 behavior, evidence, resume points | Changing Auths, or as a worked example |
| [screen-secrets.md](./screen-secrets.md) | S1 behavior, evidence, resume points | Working the active milestone |
