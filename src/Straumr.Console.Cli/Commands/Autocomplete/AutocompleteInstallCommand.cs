...
public class AutocompleteInstallCommand : AsyncCommand<AutocompleteInstallCommandSettings>
{
    ...
    public override async Task<int> ExecuteAsync(CommandContext context, AutocompleteInstallCommandSettings settings,
    ...
    private static string GetScriptResourceName(ShellKind shell)
    {
        return shell switch
        {
            ShellKind.Zsh => "Straumr.Console.Cli.Commands.Autocomplete.Scripts.completion.zsh",
            ShellKind.Bash => "Straumr.Console.Cli.Commands.Autocomplete.Scripts.completion.bash",
            ShellKind.Pwsh => "Straumr.Console.Cli.Commands.Autocomplete.Scripts.completion.ps1",
            _ => throw new ArgumentOutOfRangeException(nameof(shell))
        };
    }
